...
| `cards/<goalId>/<cardId>.json` | CardRun: state, start/deadline, owner generation, worktree, candidate, PR, review and CI ledgers, findings (ids, dispositions, re-raises), effort episode, receipts, closure flags | `loop/card-runner.ts` |
