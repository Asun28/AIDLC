...
describe('GitHubShipPath required checks and config (T1-LOOP-GATES R8)', () => {
  ...
  type Step = { name: string; title?: string; action?: boolean; at: number; end?: number; lines: string[]; later?: string[]; failed?: boolean; header?: boolean };
  /**
