...
non_goals: [the R3 reviewer command (T1-OPUS55-R3), prompt text (T1-OPUS55-PROMPTS), the gpt family defaults, max_tokens retuning, progress-update display, per-message effort, archived plans under docs/plans]
