...
requirements:
  ...
  - R3. A goal whose size is an explicit T1 or T2 shall get the arc limit, also when `--card` names one card; the goal's cards stay as given.
